...
def control(model: str, question_topic: str, sample_size: int | None = None):
...
def control_grid():
    ...
    TOGETHER_AI_MODELS = ["Qwen/Qwen3-Next-80B-A3B-Thinking"]
    for question_topic in CONTROL_TOPICS:
        for model in TOGETHER_AI_MODELS:
            control(model=model, question_topic=question_topic)
